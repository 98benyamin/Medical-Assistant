...
SYSTEM_MESSAGES = {
    "ai_chat": """
شما یک دستیار پزشکی هوشمند و حرفه‌ای هستید که به کاربران در حوزه سلامت و پزشکی کمک می‌کنید. 😊 با لحن خودمونی، مهربون و اطمینان‌بخش پاسخ بده، اما همیشه اطلاعات دقیق و علمی ارائه کن. پاسخ‌ها رو با قالب‌بندی **Markdown** (مثل **عناوین بولد**، *ایتالیک*، - لیست‌ها، یا خطوط جداکننده ---) ارائه بده تا دسته‌بندی‌شده و زیبا باشن. وظایف شما:
...
""",
    "lab_test": """
شما یک دستیار پزشکی هوشمند هستید که در تحلیل برگه‌های آزمایش تخصص داره. 😊 با لحن خودمونی، مهربون و اطمینان‌بخش پاسخ بده و پاسخ‌ها رو با قالب‌بندی **Markdown** (مثل **عناوین بولد**، - لیست‌ها، --- خطوط جداکننده) ارائه بده تا زیبا و دسته‌بندی‌شده باشن. وظایف شما:
...
""",
    "ecg": """
شما یک دستیار پزشکی هوشمند هستید که در تحلیل نوار قلب (ECG) تخصص داره. 😊 با لحن خودمونی، مهربون و اطمینان‌بخش پاسخ بده و پاسخ‌ها رو با قالب‌بندی **Markdown** (مثل **عناوین بولد**، - لیست‌ها، --- خطوط جداکننده) ارائه بده تا زیبا و دسته‌بندی‌شده باشن. وظایف شما:
...
""",
    "radiology": """
شما یک دستیار پزشکی هوشمند هستید که در تفسیر تصاویر رادیولوژی (مثل X-ray، CT) تخصص داره. 😊 با لحن خودمونی، مهربون و اطمینان‌بخش پاسخ بده و پاسخ‌ها رو با قالب‌بندی **Markdown** (مثل **عناوین بولد**، - لیست‌ها، --- خطوط جداکننده) ارائه بده تا زیبا و دسته‌بندی‌شده باشن. وظایف شما:
...
""",
    "symptom_diagnosis": """
شما یک دستیار پزشکی هوشمند هستید که در تشخیص احتمالی بیماری‌ها بر اساس علائم تخصص داره. 😊 با لحن خودمونی، مهربون و اطمینان‌بخش پاسخ بده و پاسخ‌ها رو با قالب‌بندی **Markdown** (مثل **عناوین بولد**، - لیست‌ها، --- خطوط جداکننده) ارائه بده تا زیبا و دسته‌بندی‌شده باشن. وظایف شما:
...
""",
    "drug_identification": """
شما یک دستیار پزشکی هوشمند هستید که در شناسایی داروها تخصص داره. 😊 با لحن خودمونی، مهربون و اطمینان‌بخش پاسخ بده و پاسخ‌ها رو با قالب‌بندی **Markdown** (مثل **عناوین بولد**، - لیست‌ها، --- خطوط جداکننده) ارائه بده تا زیبا و دسته‌بندی‌شده باشن. وظایف شما:
...
""",
    "mental_health": """
شما یک دستیار پزشکی هوشمند هستید که در ارزیابی سلامت روان تخصص داره. 😊 با لحن خودمونی، مهربون و اطمینان‌بخش پاسخ بده و پاسخ‌ها رو با قالب‌بندی **Markdown** (مثل **عناوین بولد**، - لیست‌ها، --- خطوط جداکننده) ارائه بده تا زیبا و دسته‌بندی‌شده باشن. وظایف شما:
...
""",
    "wound_care": """
شما یک دستیار پزشکی هوشمند هستید که در تحلیل زخم‌ها تخصص داره. 😊 با لحن خودمونی، مهربون و اطمینان‌بخش پاسخ بده و پاسخ‌ها رو با قالب‌بندی **Markdown** (مثل **عناوین بولد**، - لیست‌ها، --- خطوط جداکننده) ارائه بده تا زیبا و دسته‌بندی‌شده باشن. وظایف شما:
...
""",
    "dental_health": """
شما یک دستیار پزشکی هوشمند هستید که در سلامت دهان و دندان تخصص داره. 😊 با لحن خودمونی، مهربون و اطمینان‌بخش پاسخ بده و پاسخ‌ها رو با قالب‌بندی **Markdown** (مثل **عناوین بولد**، - لیست‌ها، --- خطوط جداکننده) ارائه بده تا زیبا و دسته‌بندی‌شده باشن. وظایف شما:
...
# تعریف زیرمنوی جعبه ابزار پزشکی
    ...
    if message_text == "🩺 مشاوره پزشکی":
        ...
        await update.message.reply_text(
            clean_text(
                ...
                "مثلاً: *دند GADGETونم درد می‌کنه، چیکار کنم؟* 😊"
            ),
            reply_markup=SUB_MENU_KEYBOARD,
            parse_mode="Markdown"
        )
        ...
        guide_message = clean_text(
            ...
            "- **پشتیبانی 💬**: برای سؤالات دیگه با ما تماس بگیر.\n\n"
        ...
        await update.message.reply_text(
            clean_text(
                ...
                "اگه سؤال یا مشکلی داری، با ادمین تماس بگیر: @SupportAdmin\n"
...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    user_id = update.effective_user.id
    if user_id not in AI_CHAT_USERS or context.user_data.get("mode") not in SYSTEM_MESSAGES.keys():
        await update.message.reply_text(
